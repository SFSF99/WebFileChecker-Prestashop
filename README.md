...
Problem: sometimes "require('../../config/' . 'settings.inc.php');" does not work.

Replace with: "require(dirname(dirname(dirname(__ FILE __))) . '/config/settings.inc.php');" (no spaces around FILE)
